        ...
        <div className="col-md-3">
          <div className="container  d-flex flex-column">
            ...
            <label className="form-label">Category
              <select className="form-control custom-select" value={fetchByCategory} onChange={onCategoryChange}>
              
              <option value="select"> Select</option>
              <i className="fa fa-caret-down" style={{fontSize:"30px"}}></i>
             ...
             <label className="form-label">Color
              <select className="form-control custom-select" value={fetchByColor} onChange={onColorChange}>
                <option value="select">Select</option>
                {color.map((color)=>{
            ...
            <label className="form-label">Order by
              <select className="form-control custom-select" value={sort} onChange={onSortChange}>
                <option value="select">Select</option>
