            ...
            <div className="col-md-6">
                {isZoom?(""):(
                    <>
                         ...
                         <div className="mt-5">
                             <h5>Share<i class="fa fa-share-alt ml-2"></i></h5>
                             <span>
                         ...
                         <div className=" py-4">
                             ...
                             (  <button onClick={removeFromCart} className="btn btn-info">Remove From Cart</button>):
                         ...
                         <button onClick={()=>setRateClicked(true)} className="btn btn-info ml-2">Rate Product</button>
                         {
                             rateClicked?(
                                ...
                                <Typography component="legend" style={{fontSize:"30px",color:"red"}}>{rating}</Typography>
                                <Rating
