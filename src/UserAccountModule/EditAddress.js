...
const updateAddress=async ()=>{
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
        <textarea className="form-control" placeholder="Address" maxLength="100" onChange={handleAddressChange} value={address}/>
  ...
  <div style={{width:"200px"}} class="form-group">
    <input type="text" class="form-control"  placeholder="Pincode" value={pin} onChange={handlePinChange}/>
  </div>
 
  <div class="form-row">
    <div class="form-group col-md-4">
    
      <input type="text" class="form-control" placeholder="City" value={city} onChange={handleCityChange}/>
    </div>
    <div class="form-group col-md-4">
    <input type="text" class="form-control" placeholder="State" value={state} onChange={handleStateChange}/>
    </div>
    
  </div>
  <div style={{width:"200px"}} class="form-group">
   
      <input class="form-control" type="text" placeholder="Country" value={country} onChange={handleCountryChange}/>
...
<hr></hr>
<div >
    <button onClick={updateAddress} className="btn btn-secondary mr-2"><i class="fa fa-save mr-2"></i>Save</button>
